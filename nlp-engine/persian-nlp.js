class PersianNLP {
    ...
    scoreSentence(sentence, fullText) {
        ...
        // امتیاز بر اساس فرکانس و موقعیت
        const frequencyScore = sentenceTokens.reduce((sum, token) => {
            return sum + (wordFrequencies[token] || 0);
